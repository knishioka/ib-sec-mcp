...
IB Analytics provides **63 tools**, **9 resources**, and **5 prompts** across two usage modes:
...
Of the 63 tools, **55 are registered by default** and **8 are gated** behind the
...
**Total: 63 tools** (55 default-enabled + 8 gated behind `IB_ENABLE_LIVE_TRADING`).
